      ...
      <div className="container">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {testimonials.map((testimonial, index) => (
            <Card key={index} className="gradient-card professional-shadow border-blue-200 dark:border-gray-700 hover:professional-shadow-lg transition-all duration-300">
